...
export module strongtypes:functionalities;
import :crtp;
import :impl;

export namespace StrongTypes
{
	template <typename T>
...
namespace std
{
	...
	struct hash<StrongTypes::NamedType<T, Parameter, Skills...>>
	{
		using NamedType = StrongTypes::NamedType<T, Parameter, Skills...>;
		using checkIfHashable = typename std::enable_if<NamedType::is_hashable, void>::type;

		size_t operator()(StrongTypes::NamedType<T, Parameter, Skills...> const& x) const noexcept
		{
